...
-- Resync crates when routing bucket changes (enter/exit properties/shells/apartments)
RegisterNetEvent('Routing:Client:NewRoute', function(_route)
    CreateThread(function()
        Wait(500)
        TriggerServerEvent('StorageCrates:Server:SyncInteriorBuckets')
        Wait(100)
        TriggerServerEvent('StorageCrates:Server:RequestCrates')
    end)
end)
